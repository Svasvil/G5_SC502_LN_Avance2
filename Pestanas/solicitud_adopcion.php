...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    // aquí solo simulamos éxito; si luego guardan en BD, reemplazan esto
    $ok = true;
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>Solicitud de Adopción - Acuario La Casa del Pez</title>
...
<body>
    ...
    <div class="contendedorNav">
        <nav class="Navegacion-Principal">
            ...
            <a class="activo" href="adopciones.html">Adopciones</a>
        </nav>
    </div>
    <br>
    ...
    <div class="contenedor-flex">
        <div class="item" style="flex:0 1 40rem;">
            <div class="card" style="width:100%;">
                <div class="card-body">
                    <?php if ($ok): ?>
                        <div class="alert alert-success">¡Solicitud enviada! Te contactaremos pronto.</div>
                    <?php endif; ?>

                    <form method="post" action="solicitud_adopcion.php">
                        ...
                        <div class="form-group">
                            <label>Especie a adoptar*</label>
                            <select name="especie" class="form-control" required>
                                <option value="">Seleccione</option>
                                <option>Pez Payaso</option>
                                <option>Caballito de mar</option>
                                <option>Pez Betta</option>
                                <option>Pez Ángel</option>
                                <option>Pez Guppy</option>
                            </select>
                        </div>

                        <div class="form-group">
                            <label>Detalles</label>
                            <textarea name="detalle" rows="4" class="form-control" placeholder="Experiencia, tamaño de acuario, parámetros, etc."></textarea>
                        </div>

                        <button type="submit" class="btnProducto">Enviar solicitud</button>
                    </form>
                </div>
            </div>
        </div>
